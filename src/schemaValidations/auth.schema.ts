...
export type SlideSessionRequestDTO = z.infer<typeof SlideSessionRequestSchema>;
export const SlideSessionResponseSchema = LoginResponseSchema;

export type SlideSessionResponseDTO = z.infer<typeof SlideSessionResponseSchema>;
